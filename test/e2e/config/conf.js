...
const config = {
  ...
  // ],
  baseUrl: process.env.TEST_URL || 'https://xui-ao-webapp-aat.service.core-compute-aat.internal/',
  params: {
    serverUrls: process.env.TEST_URL || 'https://xui-ao-webapp-aat.service.core-compute-aat.internal/',
