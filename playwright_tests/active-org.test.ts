...
test.describe('Active organisation details', () => {
  ...
  test('i can see organsation details for an active org', async ({ page }, testInfo) => {
    ...
    await runAxeAudit(page, testInfo, { reportName: 'Active organisations list' });
    ...
    await runAxeAudit(page, testInfo, { reportName: 'Active organisation details' });
    ...
    await runAxeAudit(page, testInfo, { reportName: 'Active organisation users' });
  });
});
