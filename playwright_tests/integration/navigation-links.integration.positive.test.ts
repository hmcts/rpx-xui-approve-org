...
test.describe(
  ...
  () => {
    test('Pending org details back link returns to pending list', async ({ page, organisationApprovalsPage }) => {
      const { pendingOrganisationId, pendingOrganisationName } = await setupNavigationLinksIntegrationPage(page);
    ...
    test('Active org details back link returns to active list', async ({ page, organisationApprovalsPage }) => {
      const { activeOrganisationId, activeOrganisationName } = await setupNavigationLinksIntegrationPage(page);
