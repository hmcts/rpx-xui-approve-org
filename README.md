...
- CNP and nightly pipelines run `test:a11yInTest` as an informational accessibility check. Failures are marked `UNSTABLE` for the step and do not fail the overall build.
