...
# Keep the existing Redis cache available while Managed Redis is validated.
# The application can be switched independently by changing the Key Vault
# secret referenced by Flux.
