...
export class AppUtils {
  ...
  public static mapOrganisation(apiOrg: Organisation): OrganisationVM {
    ...
    organisationVm.adminEmail = apiOrg.superUser ? apiOrg.superUser.email : '';
    ...
    organisationVm.admin = apiOrg.superUser ? `${apiOrg.superUser.firstName} ${apiOrg.superUser.lastName}` : ``;
