...
export class UsersEffects {
  ...
  public showUserDetails$ = createEffect(() => this.actions$.pipe(
  ...
  public reinviteUser$ = createEffect(() => this.actions$.pipe(
  ...
  public submitReinviteUser$ = createEffect(() => this.actions$.pipe(
