#!/usr/bin/env node
/* eslint-disable @typescript-eslint/no-require-imports, comma-dangle */
/* global process, require, module, console */

const fs = require('node:fs');
const path = require('node:path');

const DEFAULT_REPORT_FILE = 'xui-ao-playwright-accessibility.html';
...
function parseArgs(argv) {
  const options = {
    ...
    suiteName: process.env.PW_ODHIN_FALLBACK_SUITE_NAME || 'Playwright Accessibility Test',
  };
...
<html lang="en">
  ...
  <body>
    ...
    <div class="warning">
      ...
      <p>The Playwright accessibility command failed or was interrupted before the Odhín reporter wrote
