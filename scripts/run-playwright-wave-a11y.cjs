...
process.env.PLAYWRIGHT_REPORT_INDEX_FILENAME =
  process.env.PLAYWRIGHT_REPORT_INDEX_FILENAME || 'xui-ao-playwright-wave-a11y.html';
process.env.PLAYWRIGHT_REPORT_PROJECT = process.env.PLAYWRIGHT_REPORT_PROJECT || 'RPX XUI Approve Org - WAVE-like Accessibility';
process.env.PW_ODHIN_TITLE = process.env.PW_ODHIN_TITLE || 'RPX-XUI-APPROVE-ORG WAVE-like Accessibility';
process.env.FUNCTIONAL_TESTS_WORKERS = process.env.PW_WAVE_A11Y_WORKERS || process.env.FUNCTIONAL_TESTS_WORKERS || '1';
